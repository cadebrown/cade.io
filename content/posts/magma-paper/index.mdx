...
Interestingly, my [co-author won the Turing award](https://en.wikipedia.org/wiki/Jack_Dongarra). He is a legend in the HPC community, and I was very honored to work with him. I'd also like to thank [Stan Tomov](https://icl.utk.edu/~tomov/) for mentoring me and helping me get this research job.
...
Also, I have a local archive copy [here](/posts/magma-paper/dense-linear-algebra-amd-gpus-hpec-2020.pdf):

<iframe title='Dense linear algebra algorithms on AMD GPUs — HPEC 2020 paper' src='/posts/magma-paper/dense-linear-algebra-amd-gpus-hpec-2020.pdf' style="width:100%; height:900px;">
