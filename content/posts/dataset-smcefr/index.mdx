...
![Figure 1: A sample of 18 images from the `smcefr-mini` dataset](./smcefr-dataset.webp)
...
![Figure 2: Sentinel-3 Generic Filename Schema Image](./smcefr-dataset-schema.webp)
...
The dataset was distributed as a single Gzip-compressed Tar file, `smcefr-mini.tar.gz`. The archive is not currently available from this website. If you already have a copy, it can be expanded with the command:
