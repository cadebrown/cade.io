...
export function rehypeApexcharts() {
    return (tree) => {
        visit(tree, 'element', (node) => {
            ...
            if (
                ...
                if (
                    ...
                    childNode.properties.className[0] === 'language-apexcharts'
                ) {
                    ...
                    // var chartData = eval(childNode.children[0].value);
                    var chartData = childNode.children[0].value;
                    ...
                    node.properties = {
                        id: uuid,
                        className: ['rehype-apexcharts-container'],
                        'data-rehype-apexcharts': chartData
                    };
                    node.children = [];
                }
            }
