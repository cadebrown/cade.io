...
I love using markdown to write [my blog posts](/blog). Really, the plainest-text possible is my aim. However, most default markdown processors and workflows just arent expressive enough for me, and become difficult to maintain complex structures (*cough* [Jekyll](https://jekyllrb.com/) *cough*). 
