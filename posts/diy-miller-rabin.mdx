---
dated: '2021-09-03'
title: 'DIY: Primality Testing with Miller-Rabin'
blurb: 'Checking whether a number is prime is simple in theory, but can be catastrophically slow.'
image: '/assets/diy-miller-rabin/diy-miller-rabin.webp'
---
 ...
 * @name: Cade Brown <cade@cade.site>
 */
...
![performance graph up to $2^32$](/assets/diy-miller-rabin/diy-miller-rabin.webp)
